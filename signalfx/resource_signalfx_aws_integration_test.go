...
const newIntegrationAWSConfig = `
  ...
  resource "signalfx_aws_integration" "aws_myteamXX" {
	...
	regions            = ["us-east-1"]
	poll_rate          = 300
	inactive_metrics_poll_rate     = 600
...
const updatedIntegrationAWSConfig = `
  ...
  resource "signalfx_aws_integration" "aws_myteamXX" {
	...
	regions            = ["us-east-1"]
	poll_rate          = 300
	inactive_metrics_poll_rate     = 900
	import_cloud_watch = true
	enable_aws_usage   = true
		...
		Steps: []resource.TestStep{
			// Create
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("signalfx_aws_integration.aws_myteamXX", "inactive_metrics_poll_rate", "600"),
			...
			// Update
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("signalfx_aws_integration.aws_myteamXX", "poll_rate", "300"),
					resource.TestCheckResourceAttr("signalfx_aws_integration.aws_myteamXX", "inactive_metrics_poll_rate", "900"),
					resource.TestCheckResourceAttr("signalfx_aws_integration.aws_myteamXX", "metric_stats_to_sync.#", "2"),
					resource.TestCheckResourceAttr("signalfx_aws_integration.aws_myteamXX", "metric_stats_to_sync.0.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr("signalfx_aws_integration.aws_myteamXX", "metric_stats_to_sync.0.metric", "NetworkPacketsIn"),
