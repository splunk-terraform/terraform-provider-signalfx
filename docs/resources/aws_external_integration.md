...
- `external_id` (String, Sensitive) AWS external ID generated by Splunk Observability Cloud for the AWS role.
- `id` (String) The unique identifier for the resource.
- `signalfx_aws_account` (String, Sensitive) Splunk Observability Cloud AWS account ARN to use with the AWS role.
